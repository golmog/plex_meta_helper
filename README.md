...
v0.8.103 (2026-06-23)
- plex_mate, api 요청 딜레이/타임아웃 시간 조정(연장)
- 목록 아이템 상태 변화 추적 로직 수정
- 툴 별 사용자 필터(filters.yaml) 지원 추가: `filters_sample.yaml` 확인
- 필터링 기본 형식을 plain text로 변경. 정규표현식 사용시 앞에 `regex||` prefix 지정 필요.
